...
import hydra
import logging
from rfdiffusion.multistate_inference import run_multistate_inference_wrapper
...
def main(conf: HydraConfig) -> None:
    ...
    if OmegaConf.select(conf, "multistate.enable", default=False):
        run_multistate_inference_wrapper(conf)
        return
